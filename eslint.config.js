...
module.exports = [
  ...
  // Wave 0 of the relational-migration arc (2026-09-13, docs/exec-plans/completed/
  ...
  // declaring them there would trip no-redeclare).
  {
    ...
    files: ['public/js/main.js', 'public/js/watch.js', 'public/js/setup.js', 'public/js/player.js', 'public/js/books.js', 'public/js/read.js', 'public/js/stats.js', 'public/js/history.js', 'public/js/tv.js', 'lib/ytdlp/client/subscriptions.js'],
    languageOptions: {
      globals: {
        ...
        // home init, setup.js's toggle reflects + mirrors it) + the pure chip
        // resolver + bare-home layout decision main.js's gate consumes.
