...
Kept verbatim for the record - the full release story lives in Shipped below.
...
### Earlier releases (v1.30.0 and before - compact log)

These predate the current heading-plus-notes format and use a compact one-line
entry each. Kept as-is for the record, ordered newest first.
...
**Foundational features (the initial builds, before versioned releases)**
