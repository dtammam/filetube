...
- Opened: 2026-08-13
- Status: SHIPPED v1.112.0 (2026-08-13). Full gate (2 rounds) + slim gate on the
  cleanup, all APPROVED; dual-Node 6766/6766. Gate caught two real regressions
  (pre-first-chapter unreachable; dead loop-armed cue) - both fixed + mutation-
  bound. Device pass PENDING (Dean).
