...
| site | selector | decl (linter-exact) | bucket | after | expected delta | notes |
| ---- | -------- | ------------------- | ------ | ----- | -------------- | ----- |
| ~~public/css/style.css:622~~ | ~~.logo span.tube~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white-on-brand wordmark~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~public/css/style.css:764~~ | ~~.btn-primary~~ | ~~`color: white`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white-on-brand~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
...
| ~~public/css/style.css:1839~~ | ~~.audio-player-visual~~ | ~~`color: white`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~text on gradient art~~ ADOPTED-ON-OVERLAY (ruling 1 closed 2026-08-01 - THIS row is one of the two --on-overlay filings; label corrected at the gate, S2) |
...
| ~~public/css/style.css:2154~~ | ~~.watch-autoplay-thumb~~ | ~~`background-color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~toggle knob, form control~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~public/css/style.css:2300~~ | ~~.uploader-avatar~~ | ~~`color: white`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~glyph over generated avatar color~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
...
| ~~public/css/style.css:6127~~ | ~~.pinned-avatar-generated~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~public/css/style.css:6219~~ | ~~.hard-delete-modal-confirm-btn~~ | ~~`border-radius: calc(var(--radius) + 1px)`~~ | ~~RADIUS-DERIVED~~ | ~~-~~ | ~~-~~ | ~~~~ |
| ~~public/css/style.css:6248~~ | ~~.hard-delete-modal-confirm-btn~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white-on-brand~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
...
| ~~public/css/style.css:6591~~ | ~~.dl-status-chip-retry-btn~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white-on-brand~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
...
| ~~public/css/style.css:6782~~ | ~~.pinned-unpin-btn.armed~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white-on-brand armed state~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~public/css/style.css:6871~~ | ~~.books-shelf-chip.active~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white-on-brand; mid-line~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
...
| ~~public/css/style.css:7349~~ | ~~.login-wordmark .tube~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white-on-brand~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~public/css/style.css:7417~~ | ~~.login-submit~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white-on-brand~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~public/css/style.css:7465~~ | ~~.login-era-switch button[aria-pressed="true"]~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white-on-brand~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~public/css/style.css:7730~~ | ~~.music-eq i~~ | ~~`background: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white EQ glyph-art bar; --on-overlay is a text token - semantic stretch, lean residue~~ ADOPTED-ON-OVERLAY (ruling 1 closed 2026-08-01 - THIS row is one of the two --on-overlay filings; label corrected at the gate, S2) |
| ~~public/css/style.css:7731~~ | ~~.music-eq i~~ | ~~`border-radius: 1px`~~ | ~~RADIUS-GEOMETRY~~ | ~~-~~ | ~~-~~ | ~~1px cap on 3px EQ bar~~ EXEMPTED-F5D |
| ~~public/css/style.css:8039~~ | ~~.attr-picker-avatar~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~glyph over generated avatar color~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~public/css/style.css:8119~~ | ~~.notif-bell-badge~~ | ~~`border-radius: 8px`~~ | ~~RADIUS-GEOMETRY~~ | ~~-~~ | ~~-~~ | ~~half of 16px badge height~~ EXEMPTED-F5D |
| ~~public/css/style.css:8121~~ | ~~.notif-bell-badge~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white-on-brand~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~public/css/style.css:8224~~ | ~~.notif-row-avatar-generated~~ | ~~`color: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~public/js/watch.js:1170~~ | ~~applyAvatarToElement generated-avatar~~ | ~~`color: #ffffff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~mirrors subscriptions.js:1378~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
| ~~lib/ytdlp/client/subscriptions.js:1378~~ | ~~applySubAvatar generated-avatar (selector cell corrected at gate fix round 1 - the Step 3 ledger harvested a function name that never existed in this file; adversarial finding W3)~~ | ~~`color: #ffffff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white glyph on AVATAR_PALETTE color, deliberately era-invariant~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
