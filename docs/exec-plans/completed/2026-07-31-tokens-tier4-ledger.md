...
| ~~public/css/style.css:1839~~ | ~~.audio-player-visual~~ | ~~`color: white`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~text on gradient art~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
...
| ~~public/css/style.css:7730~~ | ~~.music-eq i~~ | ~~`background: #fff`~~ | ~~SEMANTIC-RESIDUE~~ | ~~-~~ | ~~-~~ | ~~white EQ glyph-art bar; --on-overlay is a text token - semantic stretch, lean residue~~ ADOPTED-ON-ACCENT (ruling 1 closed 2026-08-01; audio-player-visual + music-eq bars -> --on-overlay, disclosed reclassification) |
