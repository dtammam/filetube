...
flowchart TD
    ...
    subgraph SERVER["Node process - server.js (the monolith host)"]
        ...
        ROUTES["server.js route + middleware registrations (13 at v1.299.0-wip; 22 at v1.298.0; 98 at v1.297.0; 176 at v1.296.0 - the census counts top-level app.use too)<br/>the logo, the shell + wildcard"]
