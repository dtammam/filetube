...
flowchart TD
    ...
    subgraph SERVER["Node process - server.js (the monolith host)"]
        ...
        ROUTES["server.js route + middleware registrations (79 at v1.297.0 + Wave 7b R2 slice S3; 98 at v1.297.0; 176 at v1.296.0 - the census counts top-level app.use too)<br/>media/music/tv browse + bytes, scan, trash,<br/>move, backup, stats, config"]
