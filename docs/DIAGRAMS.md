...
flowchart TD
    ...
    subgraph SERVER["Node process - server.js (the monolith host)"]
        ...
        ROUTES["server.js route + middleware registrations (18 at v1.298.0; 98 at v1.297.0; 176 at v1.296.0 - the census counts top-level app.use too)<br/>the byte streams, scan,<br/>backup, admin"]
