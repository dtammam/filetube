...
test('registry census: a skin carries `menus` exactly when its screen is an LCD (every Click colorway), never Cider/Nordic', () => {
  ...
  assert.deepStrictEqual(skins.IDS.map((id) => skins.menuStyle(id)), ['', '', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click', 'click']);
