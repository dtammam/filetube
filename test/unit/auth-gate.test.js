...
test('allowlist: the intended pre-login surface is reachable; everything else is not', () => {
  for (const p of ['/login', '/welcome', '/logo', '/manifest.webmanifest', '/favicon.svg', '/favicon.ico', '/css/style.css', '/js/common.js', '/js/login.js', '/fonts/geist.woff2', '/fonts/roboto.woff2', '/icons/icon-192.png', '/assets/icons/outlined/home.svg']) {
