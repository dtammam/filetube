...
// media type/capability left undeclared, or a declared to-do gap (`state: 'todo'`) that
// silently appears or silently closes, all go RED at the gate - the honest version of
...
// `todo` state: a declared, committed gap. `when` is 'this-wave' | 'next-wave' | 'future'.
