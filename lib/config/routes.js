...
function registerSettingsRoutes(app, deps) {
  const {
    ...
    chapterSnap, // v1.319: lib/media/chapterSnap - the lead-in validator + read clamp
  ...
  function settingsResponse(settings) {
    return {
      ...
      // v1.319 Chapter Snap: the lead-in before a snapped chapter's first sound
  ...
  app.post('/api/settings', async (req, res) => {
    ...
    // v1.319 Chapter Snap: chapterSnapLeadInSec -- a number of seconds in
