...
// /api/config here), and the ones that named code which stayed behind -
// runScanDirectories, clearAudioStatus, the transcode loop, /api/videos,
// /api/stats - now mean "in server.js". ONE flipped side because this file's
...
// script and server.js still requires for its own reader (that file's note
// explains why one shared registry exists); the require PATH is the only byte
// this move changed.
