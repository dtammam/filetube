...
// The ONE password-length floor (v1.43.1 QA suggestion): server.js's three
// password-accepting routes and scripts/reset-admin.js all enforce this same
// constant — a floor change lands everywhere at once instead of leaving the
// recovery tool silently weaker (or stricter) than the live API.
