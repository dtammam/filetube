...
//   library - value in {video,music,podcasts,books,tv}; blocks the whole library.

const KIND_TO_LIBRARY = { media: 'video', track: 'music', podcast: 'podcasts', book: 'books', tv: 'tv' };
