...
// which is where those still live; so do GET /api/subtitles/:id's "exactly like
// /video/:id and /thumbnail/:id above" (both still in server.js) and the
// dimensions backfill's "see the comment above `newMetadata[id].width`" (inside
// runScanDirectories, in server.js) - among others. Named here rather than edited in place -
