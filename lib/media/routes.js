...
function registerBrowseRoutes(app, deps) {
  ...
  app.get('/api/videos/:id', (req, res) => {
    ...
    // time-limited). A SEPARATE field on purpose: `watchUrl` also feeds the player's chapter share
    // (`?t=` starts) and the music skins' share, which stay YouTube-only. Every other item keeps this
