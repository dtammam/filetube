...
// prepare-audio's "see GET /audio/:id's own comment". The last two mean
// server.js's, which is where those still live; `trashItem` left for
// lib/media/trash.js in slice S5 and reaches the delete route as a dep. Named
// here rather than edited in place - editing them would break the
// byte-identity the slice's verification rests on.
