...
//     is dropped exactly as JSON.stringify dropped it from the legacy JSON file;
...
function createItemsStore(adapter) {
  ...
  function planDiff(map) {
    ...
    for (const id of Object.keys(map)) {
      ...
      if (json === undefined) continue; // JSON.stringify's legacy-file semantics: the key is simply omitted
