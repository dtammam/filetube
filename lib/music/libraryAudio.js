...
// v1.221 chapter-albums: a chapter-track id encodes its file + chapter index so
// RBAC + routing decode the file back (`::` never appears in a yt-dlp/media id, so
// no collision with a real id). Round-trips: encode -> parse -> {itemId, index}.
