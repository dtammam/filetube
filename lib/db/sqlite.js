...
const CONTAINER_KEYS = ['books', 'podcasts', 'ytdlp']; // (tv, music: relational since Wave 5)
...
const RELATIONAL_IMPORT_KEYS = new Set(['viewCounts', 'progress', 'deleteTombstones', 'trash', 'settings', 'folders', 'folderSettings', 'folderDisplayNames', 'liked', 'tv', 'music']);
