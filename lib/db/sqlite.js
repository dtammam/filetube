...
// The same v11 bump also births `user_podcast_pins` (a podcast SHOW in the
// Playlists surface - Dean's intake ruling 5; the user_book_pins shape,
// pin_id = the show's subscription id, retired on unsubscribe by
// removePodcastShowPins). One bump for the wave's tables - the
// one-schema-bump law; v11 shipped nowhere before this branch merged.
