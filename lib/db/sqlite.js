...
const CONTAINER_KEYS = ['podcasts', 'ytdlp']; // (tv, music, books: relational since Wave 5)
...
const RELATIONAL_IMPORT_KEYS = new Set(['viewCounts', 'progress', 'deleteTombstones', 'trash', 'settings', 'folders', 'folderSettings', 'folderDisplayNames', 'liked', 'tv', 'music', 'books']);
