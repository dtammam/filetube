...
const SINGLETON_NAMES = [
  'folders',
  'folderSettings',
  // v1.126: per-CHANNEL-FOLDER display names { [folderName]: displayName } -
  // written by the "Refresh channel names" reconcile (a folder healing to one
  // canonical name) and by the manual rename route. Keyed by folderName,
  // deliberately mirroring the `?folder=` filter's own grouping semantics.
  'folderDisplayNames',
  // (settings: relational since Wave 4 - app_settings / lib/config/settings.js)
  'liked',
  'books.folders',
  'books.settings',
  'books.pins',
...
const RELATIONAL_IMPORT_KEYS = new Set(['viewCounts', 'progress', 'deleteTombstones', 'trash', 'settings']);
