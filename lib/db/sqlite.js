...
// SQLITE_BUSY (errcode 5) instead of waiting - which is how a parallel test file
// died at `PRAGMA journal_mode = WAL` (a statement that needs a brief exclusive
// lock) twice, taking its whole file's remaining subtests with it. Five seconds
// is far longer than any lock this app holds (every write is a short chained
// tick) and still fails loudly rather than hanging if something truly wedges.
