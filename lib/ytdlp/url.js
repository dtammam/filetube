...
function validateChannelUrl(raw) {
  ...
  // ---- FR-5 normalization pre-step (v1.16.0) -------------------------------
  ...
  // Checked against the candidate (post trim/extract, pre-URL-parse) so
  // nothing a permissive URL parser might tolerate can carry a shell
  // metacharacter or control character through validation.
