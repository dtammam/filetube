 ...
 *
 * Every candidate URL is re-validated via `sanitizeChannelAvatarUrl` again
 ...
 * join, regardless of which precedence step produced it).
 *
...
function resolveItemChannelAvatarUrl(db, item) {
  ...
  if (!channelUrl && !channelHandleUrl && !channelId) return siteBadgeAvatarUrl(item);
