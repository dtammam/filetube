...
function formatChannelNameBackfillProgressText(entry) {
  ...
  if (entry.state === 'done') {
    const parts = [`Channel-name refresh done: ${vids(itemsUpdated)} updated`];
