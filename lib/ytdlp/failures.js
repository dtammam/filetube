...
const SUBTITLE_REASON_RE = /--write-subs|--convert-subs|\.vtt\b|\.srt\b|Unable to download video subtitles for|Cannot write video subtitles file/i;
...
//
// These two additions keep the anti-spoofing property that motivated the strict
// global set in the first place. They are full ANCHORED PHRASES lifted verbatim
// from yt-dlp's own source (`YoutubeDL.py:4498` and `:4488`), not bare nouns --
// a hostile video title containing the word "subtitles" still cannot forge a
// match, because it would have to reproduce an entire error sentence.
