...
// Presence-check for a field yt-dlp reports as a NUMBER (see `viewCount`
 ...
 * @returns {Promise<{releaseDate?: number, sourceTitle?: string, viewCount?: number, chapters?: Array, channel?: {channelUrl: string, channelHandleUrl?: string, channelId?: string, channelName?: string}, wroteSubs: boolean, subsSkipped?: true} | null>}
 */
