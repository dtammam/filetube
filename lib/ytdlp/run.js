...
function runDownload(sub, config, targetIds, opts = {}) {
  ...
  return spawnYtdlpDownload(buildYtdlpDownloadArgs(sub, config, targetIds, { oneOff: opts && opts.oneOff, sourceUrl: opts && opts.sourceUrl, autoUploaderFolder: opts && opts.autoUploaderFolder }), {
