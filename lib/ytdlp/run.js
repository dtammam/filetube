 ...
 * @returns {{videoId: (string|null), channelUrl: (string|null), channelId: (string|null), uploaderUrl: (string|null), channelName: (string|null), uploadDate: (string|null), releaseDate: (string|null), viewCount: (number|string|null)} | null}
 */
function parseChannelMetaLine(line) {
  ...
  return {
    ...
    // v1.48 item 2: the day-of view count. Deliberately NOT run through
    ...
    viewCount: presentNumeric(parsed.view_count),
  };
}
