...
const { parseCapturedReleaseDate, sanitizeChannelAvatarUrl, selectChannelAvatarUrl, CHANNEL_ID_PATTERN } = require('./store');
...
async function repullItemMetaAndSubs(watchUrl, mediaFilePath, config) {
  ...
  if (releaseDate === undefined && !wroteSubs) return null;
