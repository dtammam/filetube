...
const CHANNEL_META_PRINT_TEMPLATE = `after_move:${CHANNEL_META_SENTINEL} %(.{id,channel_url,channel_id,uploader_url,channel,upload_date,release_date})j`;
...
function resiliencePacingArgs(config, opts = {}) {
  ...
  if (listOnly) {
    return ['--sleep-requests', String(sleepRequests), '--retries', String(retries)];
  }
