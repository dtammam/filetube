...
const UNIVERSAL_CHANNEL_META_PRINT_TEMPLATE = `after_move:${CHANNEL_META_SENTINEL} %(.{id,title,channel_url,channel_id,uploader_url,channel,uploader,extractor_key,upload_date,release_date,view_count,channel_follower_count,filepath})j`;
