 ...
 *
 * `db.ytdlp` access stays INSIDE this module (server.js never reads the
 * namespace -- see store.js's pins invariant), which is why this is a module
 * export rather than a few lines in server.js.
 *
