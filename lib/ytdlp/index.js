  ...
  try {
    for (const item of (Array.isArray(items) ? items : [])) {
      ...
      try {
        ...
        const viewCount = (result && result.sourceViewCount !== undefined) ? result.sourceViewCount : undefined;
        ...
        // v1.48 item 2: `viewCount` joins the OR-chain for the same reason
        ...
        const hasAnythingToPersist = releaseDate !== undefined || sourceTitle !== undefined ||
          chapters !== undefined || channel !== undefined || viewCount !== undefined ||
