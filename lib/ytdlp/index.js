...
function registerRoutes(app, deps = {}, config = parseYtdlpConfig()) {
  ...
  app.post('/api/ytdlp/repull-metadata', (req, res) => {
    ...
    const { items, eligible, ineligible, withSourceId } = deps.enumerateRepullableItems(db, config);
  ...
  app.post('/api/ytdlp/repull-metadata/preview', (req, res) => {
    ...
    let preview;
    try {
      preview = deps.previewImportRelocations(deps, config);
    } catch (err) {
  ...
  app.post('/api/ytdlp/repull-metadata/item/:mediaId', (req, res) => {
    ...
    const { items } = deps.enumerateRepullableItems(db, config);
