 ...
 * @param {Array<{channelDir?: string, channelUrl?: string, name?: string, channelId?: string}>} resolvedSubs
 ...
 * @returns {{channelUrl: string, channelName?: string, channelId?: string} | null}
 *   the matched subscription's identity fields (channelName from `sub.name`,
 *   channelId only if present), or `null` on no match / invalid input.
 */
