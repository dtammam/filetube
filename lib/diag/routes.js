...
// lib/diag/routes.js - the HTTP surface of the perf-diagnostics suite
// (branch exp/perf-diagnostics). Registered by server.js ONLY when FT_DIAG=1,
// and every route sits behind requireAdmin, so this is doubly inert/closed in a
// normal or unauthenticated context. Three groups:
//
