      ...
      for (const item of Object.values(newMetadata)) {
        ...
        // unset), so the next reheat re-persists it with no scan running.
        {
          ...
          if (freshItem) {
            ...
            // v1.338 (plan first-class-any-site D3): the saved page link, the same gap-fill (a mid-scan
            // reheat or capture may have written it; the scan's own absent / null never erases it).
