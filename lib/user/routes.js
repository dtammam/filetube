...
// S1a, of the relational-migration arc (docs/exec-plans/completed/
...
// The SYNCED allowlist (exec plan docs/exec-plans/completed/2026-09-04-cross-device-sync.md,
// MACHINE-DERIVED, 20 keys since v1.312). The server is the enforcement point: unknown keys
...
function registerRoutes(app, deps) {
  ...
  app.post('/api/prefs', (req, res) => {
    ...
    for (const e of raw.slice(0, 64)) { // batch cap: the allowlist is 20 keys
