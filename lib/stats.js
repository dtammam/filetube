...
// zero real benefit.
//
// "Most-watched" reads `item.viewCount` off the items it is HANDED. Since
// v1.42 the persisted counter lives in `db.viewCounts[id]` (extracted out of
// the metadata item, where the scan could clobber it); the stats route
