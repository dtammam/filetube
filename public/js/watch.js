...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getMockInitialComments() {
    const commentBank = [
      ...
      // Friends
      { author: 'Joe Dowden', text: 'certified banger. shipping straight to prod, no tests. 🚀', timeStr: '2 days ago' },
      { author: 'Joe Dowden', text: 'you built this instead of sleeping again didn\'t you', timeStr: '5 days ago' },
      { author: 'Joe Dowden', text: 'peak self-hosting. 10/10, would spin up a container for.', timeStr: '1 week ago' },
      { author: 'Jesahel Vallejo', text: 'okay this is actually incredible, i have no notes', timeStr: '3 days ago' },
      { author: 'Jesahel Vallejo', text: 'the double-tap skip is chef\'s kiss 👨‍🍳', timeStr: '4 days ago' },
      { author: 'Jesahel Vallejo', text: 'self-hosted supremacy. no ads, no login. we won. 🙌', timeStr: '2 weeks ago' },
      { author: 'Jesse Torres', text: 'bro really built YouTube over a weekend and made it look easy', timeStr: '6 days ago' },
      { author: 'Jesse Torres', text: 'loads faster than my deploy pipeline and honestly that hurts me', timeStr: '2 days ago' },
      { author: 'Jesse Torres', text: 'zero ads, instant load, i\'m getting emotional about it', timeStr: '1 week ago' },

      // Family
      { author: 'Ray Tammam', text: 'Look at what you built. Genuinely proud of you, son.', timeStr: '2 days ago' },
      { author: 'Ray Tammam', text: 'Your own YouTube, running in your own house. Remarkable work.', timeStr: '1 week ago' },
      { author: 'Ray Tammam', text: 'Saved it to my machine. Show me the skip trick next time you visit.', timeStr: '4 days ago' },
      { author: 'Marcy Tammam', text: 'So proud of you, honey! I already sent it to the whole family. ❤️', timeStr: '3 days ago' },
      { author: 'Marcy Tammam', text: 'This is wonderful sweetheart. Did you remember to eat today?', timeStr: '1 day ago' },
      { author: 'Marcy Tammam', text: 'My brilliant kid made his own streaming site. Framing this comment.', timeStr: '6 days ago' },

      // Daisy 💛
      { author: 'Daisy Tammam', text: 'hi daddy!! this is the BEST video in the whole wide world 💖', timeStr: '1 day ago' },
      { author: 'Daisy Tammam', text: 'i love you dad 💕', timeStr: '2 hours ago' },
      { author: 'Daisy Tammam', text: 'my daddy made this and he is the smartest person EVER ⭐', timeStr: '3 days ago' },
      { author: 'Daisy Tammam', text: 'can we watch it again pleeeease daddy', timeStr: '5 hours ago' },
      { author: 'Daisy Tammam', text: 'i gave this ten thousand stars ⭐⭐⭐⭐⭐', timeStr: '1 week ago' },
      { author: 'Daisy Tammam', text: 'watching with my juice box, best day ever 🧃', timeStr: '4 days ago' },
      { author: 'Daisy Tammam', text: 'i drew you a picture of this video daddy, its on the fridge 🎨', timeStr: '2 days ago' },
      { author: 'Daisy Tammam', text: 'love you to the moon and back daddy 🌙', timeStr: '6 hours ago' },
      { author: 'Daisy Tammam', text: 'my stuffed animals are watching too and they say hi 🧸', timeStr: '3 weeks ago' },
      { author: 'Daisy Tammam', text: 'you are my favorite youtuber AND my favorite daddy 💛', timeStr: '1 day ago' },
      { author: 'Daisy Tammam', text: 'this is my favorite because my dad made it just for us 🥰', timeStr: '5 days ago' },
      { author: 'Daisy Tammam', text: 'i love you daddy so so so so much 💗', timeStr: 'just now' }
    ];
