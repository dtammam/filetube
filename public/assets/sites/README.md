...
The marks are from Simple Icons 16.32.0 (https://simpleicons.org), released under CC0-1.0; the colour
is each brand's Simple Icons hex. The names and marks remain their owners' trademarks; they are used
here only to show which site a download came from. The server maps a yt-dlp extractor key to a file
by prefix (lib/ytdlp/store.js siteBadgeAvatarUrl).
